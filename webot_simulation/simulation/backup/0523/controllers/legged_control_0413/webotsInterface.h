...
// //-----------------------------------------------------------extern
// extern void webots_device_init();
// extern void set_motor_torque(MotorIndex m, double torque);
// extern void set_motor_position(MotorIndex m, double angle);
// extern double get_motor_angle(MotorIndex m);
// extern int get_keyboard();
// extern eulerAngleTypeDef get_IMU_Angle();
// //extern void get_camera();
// #endif
